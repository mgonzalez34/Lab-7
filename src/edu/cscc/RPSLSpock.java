...
public class RPSLSpock {
    ...
    /**
     * check for pick's validity
     * @param pick Users Pick
     * @return boolean to check if the User's Pick is valid
     */
    ...
    /**
     * Check who wins
     * @param c_pick Computer's valid random pick
     * @param h_pick User's valid pick
     * @return boolean, true if computer wins, false if the user wins
     */
